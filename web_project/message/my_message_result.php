                  ...
                  ?>
                    ...
                    <?php if($board=="send"){ ?>
                      ...
                      <?php
                         ...
                         <td width="500"><strong><a href="message_rvview.php?board=rv&num=<?=$message['idx']?>"><?php echo  $content;?>
                        </a></strong></td>
                      <?php
                         }
                         else{
            ...
            <ul>
              <?php
                ...
                { //만약 page가 1이라면
                  ...
                  echo "<li><a href='my_message_result.php?info=message&board=$board&page=1'>처음</a></li>"; 
                  //처음글자에 1번페이지로 갈 수있게 링크
                }
                if($page > 1)
                {
                  $pre = $page-1;
                ...
                if($page >= $total_page){ //만약 page가 페이지수보다 크거나 같다면
                  ...
                  echo "<li><my_message_result.php?info=message&board=$board&page=$total_page'>마지막</a></li>"; 
                  //아니라면 마지막글자에 total_page를 링크한다.
                }
