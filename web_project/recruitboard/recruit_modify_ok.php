<!-- recruit_modify_ok db에 저장된 글 수정 -->
<?php
	...
	$sql = mq("update recruit_board set title = '".$title."',  category = '".$category."', 
	period_s = '".$startdate."', period_e = '".$enddate."', content = '".$content."', file = '".$upfile_name."', 
	file_type ='".$upfile_type."', file_copied = '".$copied_file_name."' where idx = '".$rno."'");
		}
		else{
			$sql = mq("update recruit_board set title = '".$title."',  category = '".$category."', period_s = '".$startdate."',
			 period_e = '".$enddate."', content = '".$content."', file = '".$upfile_name."', file_type ='".$upfile_type."'
			  where idx = '".$rno."'");
		}
	echo "<script>
			alert('수정이 완료되었습니다.');
