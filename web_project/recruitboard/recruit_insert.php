...
<?php
	...
	$sql = mq("insert into recruit_board (user_id, nic_name, title, category, period_s, period_e, content, file, file_type,
	 date, file_copied) 
	values('".$username."','".$usernic."', '".$title."', '".$category."', '".$startdate."',
	 '".$enddate."', '".$content."', '".$upfile_name."', '".$upfile_type."','".$date."', '".$copied_file_name."');");
		}else{ $sql = mq("insert into recruit_board (user_id, nic_name, title, category, period_s, period_e, content, file, 
			file_type, date, file_copied) 
	values('".$username."','".$usernic."', '".$title."', '".$category."', '".$startdate."', '".$enddate."',
	 '".$content."', '".$upfile_name."', '".$upfile_type."','".$date."', 0);");}
