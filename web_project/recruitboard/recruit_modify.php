	    ...
	    <form  name="board_form" method="post" action="recruit_modify_ok.php?idx=<?php echo $rno; ?>" enctype="multipart/form-data">
	    	 <ul id="board_form">		
                ...
                <li>
	    			...
	    			<span class="col2">
                        <input name="startdate" type="date" width="50" value=<?php echo $board['period_s']; ?>> 
                        ~ <input name="enddate" type="date" width="50" value=<?php echo $board['period_e']; ?>></span>
	    		</li>
	    		<li id="text_area">	
