<div class="wrapper splitclrs">
  <div class="split clear">
    <div> 
      ...
      <a class="plus" target="iframe1" href="board/board.php?board_id=board">더보기 &raquo;</a>
      <hr>
      <?php
    ...
    <div>
      ...
      <a class="plus" href="bookboard/book_list.php">더보기 &raquo;</a>
      <hr>
          <?php
    ...
    <div> 
      ...
      <a class="plus" href="recruitboard/recruit.php">더보기 &raquo;</a>
      <hr>
      <?php
      ...
      <a class="plus" href="itemboard/item_list.php">더보기 &raquo;</a>
      <hr>
          <?php
