      ...
      <ul style="display:table;">
        ...
        <?php
           ...
           <li>
            ...
            {
            ?>
        <li style='margin-left: 15px;'><a href="../web_project/user/login.php">로그인</a></li>
...
<div class="wrapper row4">
  <nav id="mainav" class="hoc clear" > 
    <ul class="clear" style="display:block;">
      <li><a href="../board/board.php?board_id=board">커뮤니티</a>
        <ul>
          <li><a  href="../board/board.php?board_id=notice">공지사항</a></li>
          <li><a  href="../board/board.php?board_id=board">자유게시판</a></li>
        </ul>
      </li>
      <li><a  href="../bookboard/book_list.php?board_id=book_board">거래게시판</a>
        <ul>
          <li><a  href="../bookboard/book_list.php">도서거래 게시판</a></li>
          <li><a  href="../itemboard/item_list.php">중고거래 게시판</a></li>
        </ul>
      </li>
      <li><a  href="../recruitboard/recruit.php">모집게시판</a>
        <ul>
      </li>
    </ul>
  </nav>
