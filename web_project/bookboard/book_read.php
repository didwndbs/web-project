...
<head>
 ...
 #comments li { color: inherit;  background-color: #FBFBFB}
#comments .comcont { display: block; margin: 0; padding: 10px 0 15px 0; 
	border-bottom: solid 1px gray;}
#popup_menu_area{position: absolute; width: 150px; height: 23px; text-align: center;
	background-color: white; border: solid 1px gray;}
.splitclrs{ background:#ffffff;}
@media screen and (max-width:750px){.splitclrs{background:none;}
	.split > div:first-child{color:inherit; background-color:#F6F6F6;}
	.split > div:last-child{color:inherit; background-color:#FFFFFF;}
}
img{margin: 0 15px 10px 0; clear: left;}
</style>
</head>
<body id="top">
<header>
