        ...
        <?php
           ...
           if($info == "content"){
              ...
              echo "
                ...
                $sql2 = mq("SELECT book_board.idx, book_board.title, book_board_reply. * from book_board inner join book_board_reply on book_board.idx = book_board_reply.con_num 
                where book_board_reply.id = '$userid' UNION ALL 
                ...
                SELECT recruit_board.idx, recruit_board.title, recruit_board_reply. * from recruit_board join recruit_board_reply on recruit_board.idx = recruit_board_reply.con_num
                 where recruit_board_reply.id = '$userid' UNION ALL
                SELECT item_board.idx, item_board.title, item_board_reply. * from item_board join item_board_reply on item_board.idx = item_board_reply.con_num 
                where item_board_reply.id = '$userid';");
